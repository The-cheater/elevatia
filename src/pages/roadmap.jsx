...
import { Code, Database, Cloud, BrainCircuit, Network, Smartphone, Lock, Bug, Webhook, Cpu } from "lucide-react";
...
const CSERoadmapPage = () => {
  ...
  const courses = [
    ...
    },
    {
      ...
      icon: <Cpu className="w-8 h-8" />, // Added icon for Machine Learning
      color: "bg-green-500",
